        ...
        <div className='music'>
            <div className="m-main">
                <ul className="m_top-bar">
                    <li>
                        <button className="m-btn m-minimize">
                    ...
                    <li>
                        <button className="m-btn m-close">
                ...
                <div className="m-currentplaying">
                    ...
                    <p className="m-heading">Currently Playing</p>
                </div>
                <div className="m-songs">
                    <div className="m-loader">
                        <div className="m-song">
                            <p className="m-name">Time in a Bottle</p>
                            <p className="m-artist">Jim Corce</p>
                        </div>
                        <div className="m-albumcover"></div>
                    ...
                    <div className="m-loader">
                        <div className="m-song">
                            <p className="m-name">My Way</p>
                            <p className="m-artist">Frank Sinatra</p>
                        </div>
                        <div className="m-albumcover"></div>
                    ...
                    <div className="m-loader">
                        <div className="m-song">
                            <p className="m-name">Lemon Tree</p>
                            <p className="m-artist">Fools Garden</p>
                        </div>
                        <div className="m-albumcover"></div>
                        <div className="m-play"></div>
                    </div>
